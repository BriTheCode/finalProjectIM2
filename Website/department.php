...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($checkResult) > 0) {
      ...
      if (!empty($departmentname) && !empty($location)) {
          $insertQuery = "INSERT INTO departments (user_id, department_name, location) VALUES ('$userid', '$departmentname', '$location')";
 ...
 if(isset($_POST['update-button'])){
  ...
  $departmentname = $_POST['departmentname'];
  $location = $_POST['location'];
  $updatequery = "UPDATE departments set department_name = '$departmentname', location = '$location' WHERE user_id = '$updateid'";
        ...
        <tbody>
          <?php
            ...
            if ($search != "") {
              ...
              $retrieve = "SELECT r.user_id, d.department_id, d.department_name, d.location FROM departments d JOIN registration r ON r.user_id = d.user_id;";
          }
          ...
          while ($rows = mysqli_fetch_assoc($result)){
            ...
            <tr>
                ...
                <td><a href="#" class="btn btn-success update-btn" data-id="<?php echo $rows['user_id']; ?>" data-name="<?php echo $rows['department_name']; ?>" data-email="<?php echo $rows['location']; ?>" data-bs-toggle="modal" data-bs-target="#updateModal">Update</a></td>
